...
int heading()
{
    ...
    space(s1);
    cout<<"\n";
    cout<<"Submitted to: DR. Siddharth Bhorge"<<endl;
    cout<<"Submitted by: "<<endl<<"Aditi Taru		12220028"<<endl<<"Pratik Biradar		12220313"<<endl<<"Pranav Chougule		12220295"<<endl<<"Ganesh Gaikwad		12220152"<<endl;
    line_break();
}
